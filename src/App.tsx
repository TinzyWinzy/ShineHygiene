...
export default function App() {
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-gray-50 via-white to-gray-50 flex flex-col relative">
      ...
      >
        <div className="max-w-3xl mx-auto px-4 py-2.5 flex items-center gap-3">
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ duration: 0.3, delay: 0.1, type: 'spring', stiffness: 300, damping: 15 }}
          ...
          <div>
            <h1 className="text-base font-bold text-brand-dark tracking-tight leading-tight">
              Shine Hygiene Solutions
            </h1>
            <p className="text-[11px] text-gray-400">Instant Quote Engine</p>
          </div>
          <div className="ml-auto flex items-center gap-2">
            <motion.a
              href="mailto:sales@shineclean.co.zw"
              whileHover={{ scale: 1.05 }}
              className="text-xs text-gray-400 hover:text-brand transition-colors hidden sm:block"
            >
              Contact
            </motion.a>
          </div>
          ...
          {submitted ? (
            ...
            >
              ...
              <AnimatedSection direction="up" delay={0.1}>
                <motion.div
                  layout
                  className="bg-white/70 backdrop-blur-xl rounded-2xl border border-gray-200/60 shadow-lg shadow-gray-200/50 p-5"
                >
                  {changing ? (
